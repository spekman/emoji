...
export default function PetEmoji({ emoji, size = PET_SIZE, dropZoneRef, updateDropZone, dropPulse = false, pettingActive = false, isSleeping = false, onWakeUp }: PetEmojiProps) {
